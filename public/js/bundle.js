...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = __webpack_require__(/*! ../scripts/home.jsx */ 159);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = __webpack_require__(/*! ./global/modal_window.jsx */ 160);
	var ResumeBuilder = __webpack_require__(/*! ./global/resume_builder.jsx */ 162);
	...
	var Home = React.createClass({
	   ...
	   handleTranslate: function handleTranslate() {
	   ...
	   render: function render() {
	      return React.createElement(
	         "div",
	         { className: "main", onScroll: this.handleScroll },
	         React.createElement(
	            "div",
	            { className: "layer-group" },
	            React.createElement(
	               "div",
	               { className: "layer-base top" },
	               React.createElement(
	                  "div",
	                  { className: "title-box-name" },
	                  React.createElement(
	                     "p",
	                     { className: "title font-page-header" },
	                     "Michael Hottman"
	                  ),
	                  React.createElement(
	                     "div",
	                     ...
	                     React.createElement(
	                        "p",
	                        { className: "font-center font-small" },
	                        "Web Developer & ",
	                        this.state.subtitle
	                     )
	                  )
	            ...
	            React.createElement(
	               "div",
	               { className: "layer-upper" },
	               React.createElement(
	                  Modal,
	                  { className: "open-modal-button", type: "button", open: false, label: "Open Modal" },
	                  React.createElement(
	                     "h3",
	                     { className: "font-small font-center" },
	                     "|___|__ ... __|___|"
	                  )
	               )
	            ),
	            React.createElement(
	               "div",
	               { id: "resume", className: "layer-base resume" },
	               React.createElement(
	                  "div",
	                  { className: "layer-base-inner" },
	                  React.createElement(
	                     "div",
	                     { className: "layer-base-title" },
	                     React.createElement(
	                        "h1",
	                        { className: "font-large font-center" },
	                        "Resume"
	                     )
	                  ),
	                  React.createElement(
	                     Modal,
	                     { className: "open-modal-button resume-item", open: false, label: "Item 1" },
	                     React.createElement(
	                        "h1",
	                        { className: "font-large" },
	                        "This is open modal 1.."
	                     )
	                  ),
	                  React.createElement(
	                     Modal,
	                     { className: "open-modal-button resume-item", open: false, label: "Item 2" },
	                     React.createElement(
	                        "h1",
	                        { className: "font-large" },
	                        "This is open modal 2.."
	                     )
	                  ),
	                  React.createElement(
	                     Modal,
	                     { className: "open-modal-button resume-item", open: false, label: "Item 3" },
	                     React.createElement(
	                        "h1",
	                        { className: "font-large" },
	                        "This is open modal 3.."
	                     )
	                  ),
	                  React.createElement(
	                     Modal,
	                     { className: "open-modal-button resume-item", open: false, label: "Item 4" },
	                     React.createElement(
	                        "h1",
	                        { className: "font-large" },
	                        "This is open modal 4.."
	                     )
	                  )
	               )
	            ),
	            React.createElement("div", { className: "layer-upper" }),
	            React.createElement("div", { className: "layer-base bottom" })
	         )
	      );
	   }
	});
...
/* 160 */
/*!*****************************************!*\
  !*** ./scripts/global/modal_window.jsx ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = __webpack_require__(/*! ./modal.jsx */ 161);
	...
	var ModalWindow = React.createClass({
		...
		mapChildren: function mapChildren(child) {
		...
		render: function render() {
			...
			return React.createElement(
				'div',
				_extends({ onClick: this.toggle }, this.props),
				this.props.label,
				React.createElement(
					Modal,
					{ className: 'modal-inner', isOpen: this.state.open, close: this.toggle.bind(this, false) },
					children
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  doRender: function doRender(props) {
	    ReactDOM.render(React.createElement(
	      'div',
	      { style: { overflow: 'auto' }, onClick: this.handleClick, className: 'modal-backdrop' },
	      React.createElement(
	        'div',
	        props,
	        props.children
...
/* 162 */
/*!*******************************************!*\
  !*** ./scripts/global/resume_builder.jsx ***!
  \*******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 1);
	var ReactDOM = __webpack_require__(/*! react-dom */ 158);
	var cx = __webpack_require__(/*! classnames */ 163);
	
	var ResumeBuilder = React.createClass({
	   displayName: "ResumeBuilder",
	   ...
	   expandCard: function expandCard(field, e) {
	      e.preventDefault();
	   ...
	   render: function render() {
	      ...
	      return React.createElement(
	         ...
	         React.createElement(
	            "div",
	            { className: "card " + isOpen, onClick: this.expandCard.bind(this, 'special') },
	            React.createElement(
	               "h1",
